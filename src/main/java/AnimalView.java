...
/**
 * Класс, обеспечивающий UI (User Interface). <br>
 * Производит отображение данных для пользователя, обработка пользовательского ввода.
 * Не содержит бизнес-логики, только отображает данные, полученные от презентера,
...
public class AnimalView extends ColoredConsole{
    ...
    /**
     * <u>Контролируемый ввод.</u><br>
     * В бесконечном цикле происходит проверка пользовательского ввода. Цикл заканчивается только тогда,
     * когда ввод пользователя соответствует регулярному выражению. Иначе выводится предупреждающее сообщение
     * и приглашение осуществить ввод данных заново.
     * @param message сообщение пользователю - что именно он должен ввести.
     * @param regEx регулярное выражение, на которое проверяется пользовательский ввод
     * @return строка String, которую ввёл пользователь.
     */
    ...
    /**
     * <u>Контролируемый ввод даты.</u><br>
     * Ввод пользователя подвергается нескольким проверкам:<br>
     * 1. соответствие формату даты dd.MM.yyyy.<br>
     * 2. Не находится ли дата в будущем.
     * @param message
     * @return
     */
    ...
    /**
     * Декорирование заголовка в рамку.
     * Можно задать цвет рамки и цвет текста.
    ...
    /**
     * Отрисовка таблицы для вывода данных о животном
     * @param animalInfo
     */
    public void showCurrentAnimal(String animalInfo) {
